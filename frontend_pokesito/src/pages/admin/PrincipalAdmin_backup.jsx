  ...
  return (
    <div className="dashboard-container">
      ...
      <nav className="dashboard-nav">
        ...
        <Link to="/admin/habilidades" className="nav-link">
      ...
      <main className="dashboard-content">
        ...
        <div className="dashboard-cards">
          ...
          <div className="card admin-card">
            <h3>✨ Habilidades</h3>
            <p>Gestionar habilidades de Pokémon</p>
            <Link to="/admin/habilidades" className="card-link">Gestionar Habilidades</Link>
          </div>
